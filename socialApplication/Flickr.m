...
#define kFlickrAPIKey @"06db29b622a83e1eddc6e20d84dbff2c"           //new flickr key obtained from flickr website

@implementation Flickr

+ (NSString *)flickrSearchURLForSearchTerm:(NSString *) searchTerm          //this creates a search url for flickr this will be used to search images according to the key
{
